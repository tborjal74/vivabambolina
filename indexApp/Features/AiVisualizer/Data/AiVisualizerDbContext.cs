...
public sealed class AiVisualizerDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CustomerMeasurement>(entity =>
        {
            ...
            entity.Property(measurement => measurement.Height).HasColumnName("height").HasPrecision(6, 2);
            entity.Property(measurement => measurement.Bust).HasColumnName("bust").HasPrecision(6, 2);
            entity.Property(measurement => measurement.Waist).HasColumnName("waist").HasPrecision(6, 2);
            entity.Property(measurement => measurement.Hips).HasColumnName("hips").HasPrecision(6, 2);
            entity.Property(measurement => measurement.ShoulderWidth).HasColumnName("shoulder_width").HasPrecision(6, 2);
            entity.Property(measurement => measurement.DressLength).HasColumnName("dress_length").HasPrecision(6, 2);
            entity.Property(measurement => measurement.SleeveLength).HasColumnName("sleeve_length").HasPrecision(6, 2);
            entity.Property(measurement => measurement.Wrist).HasColumnName("wrist").HasPrecision(6, 2);
